 ...
 
{
  ...
  runtime_ptr->trace_callstack( "MPI_Send" );
}
    return _wrap_py_return_val;
}
 ...
 
{
  ...
  runtime_ptr->trace_callstack( "MPI_Isend" );
}
    return _wrap_py_return_val;
}
    ...
    int _wrap_py_return_val = 0;
{
  ...
  runtime_ptr->trace_callstack( "MPI_Bsend" );
}
    return _wrap_py_return_val;
}
    ...
    int _wrap_py_return_val = 0;
{
  ...
  runtime_ptr->trace_callstack( "MPI_Ibsend" );
}
    return _wrap_py_return_val;
}
 ...
 
{
  ...
  runtime_ptr->trace_callstack( "MPI_Irsend" );
}
    return _wrap_py_return_val;
}
 ...
 
{
  ...
  runtime_ptr->trace_callstack( "MPI_Issend" );
}
    return _wrap_py_return_val;
}
 ...
 
{
  ...
  runtime_ptr->trace_callstack( "MPI_Rsend" );
}
    return _wrap_py_return_val;
}
    ...
    int _wrap_py_return_val = 0;
{
  ...
  runtime_ptr->trace_callstack( "MPI_Ssend" );
}
    return _wrap_py_return_val;
}
 ...
 
{
  ...
  runtime_ptr->trace_callstack( "MPI_Irecv" );
}
    return _wrap_py_return_val;
}
    ...
    int _wrap_py_return_val = 0;
{
  ...
  // Case 1: Matched test
  if (*arg_1) {
    runtime_ptr->trace_callstack( "MPI_Test" );
  }
  // Case 2: Unmatched test
  else {
    if ( runtime_ptr->trace_unmatched() ) {
      runtime_ptr->trace_callstack( "MPI_Test" );
    } 
  }
}
 ...
 
{
  ...
  // Case 1: Matched test
  if (*arg_2) {
    runtime_ptr->trace_callstack( "MPI_Testall" );
  }
  // Case 2: Unmatched test
  else {
    if ( runtime_ptr->trace_unmatched() ) {
 ...
 
{
  ...
  // Case 1: Matched test
  if (*arg_3) {
    runtime_ptr->trace_callstack( "MPI_Testany" );
  }
  // Case 2: Unmatched test
  else {
    if ( runtime_ptr->trace_unmatched() ) {
 ...
 
{
  ...
  if (num_completed_reqs > 0) {
    runtime_ptr->trace_callstack( "MPI_Testsome" );
  }
  // Case 2: Unmatched test
  else {
    if ( runtime_ptr->trace_unmatched() ) {
 ...
 
{
  ...
  runtime_ptr->trace_callstack( "MPI_Wait" );
}
    return _wrap_py_return_val;
}
 ...
 
{
  ...
  runtime_ptr->trace_callstack( "MPI_Waitall" );
}
    return _wrap_py_return_val;
}
 ...
 
{
  ...
  runtime_ptr->trace_callstack( "MPI_Waitany" );
}
    return _wrap_py_return_val;
}
 ...
 
{
  ...
  runtime_ptr->trace_callstack( "MPI_Waitsome" );
}
    return _wrap_py_return_val;
}
 ...
 
{
  ...
  runtime_ptr->trace_callstack( "MPI_Probe" );
}
    return _wrap_py_return_val;
}
 ...
 
{
  ...
  if ( *flag ) {
    runtime_ptr->trace_callstack( "MPI_Iprobe" );
  } 
  else {
    if ( runtime_ptr->trace_unmatched() ) {
      runtime_ptr->trace_callstack( "MPI_Iprobe" );
